...
export type CombatResult = { resolutionMode: 'manual' | 'simulation'; winner: 'player1' | 'player2' | 'draw'; player1: CombatPlayerResult; player2: CombatPlayerResult; player1Total: number; player2Total: number }