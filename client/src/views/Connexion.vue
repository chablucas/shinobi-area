...
.auth-panel { display: grid; gap: 10px; width: calc(100% - 40px); max-width: 500px; margin: 64px auto; padding: 34px; background: var(--bg-panel); border: 1px solid var(--border-light); clip-path: var(--clip-soft); }
.auth-panel h1 { margin: 8px 0 18px; font-size: clamp(2.5rem, 7vw, 4rem); line-height: .95; text-transform: uppercase; }
